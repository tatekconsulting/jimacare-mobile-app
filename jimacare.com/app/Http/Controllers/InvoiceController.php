...
class InvoiceController extends Controller
{
    ...
    public function processPayment(Invoice $invoice, Request $request){
		...
		$userId = ($invoice->message->inbox->seller_id != $invoice->message->from_id) ? ($invoice->message->inbox->seller_id) : ($invoice->message->inbox->client_id);
		$client = User::find($userId);
		Mail::to('billing@jimacare.com')->send(new PaymentMail($client,$invoice));
