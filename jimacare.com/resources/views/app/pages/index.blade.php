			...
			<div class="row">
				<div class="col-12 col-lg-7 col-md-9">
					...
					@else
						<div class="row">
							<div class="col-12">
								<h3 class="font-italic">Welcome to JimaCare</h3>
								<h1 class="text-white">Find Your Perfect Care Opportunity</h1>
								<p class="text-white mt-3">Browse available jobs and connect with clients who need your services.</p>
								<a href="{{ route('contract.index') }}" class="btn btn-primary btn-lg mt-4">
			...
			<div class="job-box">
				<div class="row">
					...
					<div class="col-12 order-2 order-md-1">
						...
						<p>
							We make it very easy for you to work with an experienced Carers, Childminders and Housekeepers.
							Contact us today whether you require someone who speaks a foreign language, drives or has
							...
							<div class="col-md-12 col-sm-12 col-12">
								<ul class="faqs-accordian">
									<li>
										...
										<div>
											Jimacare is CQC registered Care service provider. We are here to provide a professional service that client will be happy with.
										</div>
									</li>
										...
										<div class="col-lg-9 col-md-8 col-sm-8 col-12">
											<div class="client-content">
												...
												<p class="text-justify">I was searching online and stumbled at
													Jimacare.com. I reached out to customer service team and a professional and friendly carer was sent to my house immediately. The price fits in to
													my plan to hire a carer for my wife. I’ m so happy for getting
