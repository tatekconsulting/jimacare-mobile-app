					...
					<div class="row">
						<div class="seller-left text-center col-12 col-md-auto">
							<div class="seller-img">
								<img class="img img-fluid rounded-circle seller-avatar" src="{{ asset($contract->user->profile ?? 'img/undraw_profile.svg') }}" alt="{{ $contract->user->firstname }} {{ $contract->user->lastname }}">
							</div>
							<div class="mb-1">
