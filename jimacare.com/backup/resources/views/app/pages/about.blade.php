		...
		<div class="container">
			<div class="row mt-5 pt-4 mb-5 pb-4">
				...
				<div class="col-lg-7 col-md-6 col-sm-12 col-12">
					...
					<p class="pt-5 mt-3">Jimacare is an online platform that helps Care homes and families to find Carer and housekeeper while creating employment opportunities for Carers and housekeepers.</p>
						...
						<ul>
							<li class="border-bottom">
								...
								<p>
									...
									We provide a quality platform to search for job by connecting carers with private client with a fee
									of just 12.1%(plus VAT).
								</p>
							</li>
							<li class="border-bottom">
								<span>02</span>
